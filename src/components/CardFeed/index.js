...
function CardFeed({ feed }) {
  ...
  if (feed === null)
    return (
      ...
      >
        <EmptyMessage message='Get ready to follow all your friends and be able to see the photos they share, what are you waiting for, start following your friends or acquaintances' />
      </Card>
    );
    ...
    <Card>
      ...
      <CardFooter>
        <form onSubmit={hanldeSubmit}>
          ...
          />
          <button type='submit' value='Post' disabled={disabled}>
            Post
          </button>
        </form>
      </CardFooter>
